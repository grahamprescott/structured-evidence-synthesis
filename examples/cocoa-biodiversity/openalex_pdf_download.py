...
SEARCH_PARAMS = {
    # cocoa-biodiversity-yield-2026-05 — see context/search_log.json
    "filter": "title_and_abstract.search:cocoa yield biodiversity,type:article,is_oa:true,language:en,from_publication_date:2010-01-01",
}
EMAIL = "grahamprescott@gmail.com"
