...
**Version 0.0.1 — proof of concept.** A protocol, ontology, and extraction schema for AI-assisted evidence synthesis from scientific literature, with a paired audit step.
